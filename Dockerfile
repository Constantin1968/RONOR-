...
# Isolated post-agent verifier. It contains Git and the RONOR verification
# service, but receives no runtime, model, GitHub, SSH or cloud credentials.
FROM runtime AS evidence-runner
USER root
