...
def cover():
    o = [Spacer(1, 28 * mm)]
    o.append(Paragraph("RAPORT DE CONSTATARE", S["cover_t"]))
    o.append(Spacer(1, 5))
    ...
    o.append(Spacer(1, 3))
    o.append(Paragraph("Audit tehnic de stare &#537;i securitate", S["cover_s2"]))
    ...
    o.append(Paragraph(
        "Toate valorile din acest raport au fost m\u0103surate prin sondare live, "
...
def main(src, out):
    ...
    doc = BaseDocTemplate(out, pagesize=A4,
                          ...
                          title="RONOR \u2014 Raport de constatare, 25 august 2026",
                          author="Perplexity Computer",
                          subject="Audit tehnic de stare \u0219i securitate",
