...
def cover():
    o = [Spacer(1, 28 * mm)]
    o.append(Paragraph("RAPORT DE MĂSURARE", S["cover_t"]))
    o.append(Paragraph("ȘI ÎNSĂNĂTOȘIRE", S["cover_t"]))
    o.append(Spacer(1, 5))
    ...
    o.append(Spacer(1, 3))
    o.append(Paragraph("Constatări măsurate direct, cu acces administrativ pe gazdele principale", S["cover_s2"]))
    o.append(Spacer(1, 15 * mm))
    rows = [
        ["Obiect", "Măsurarea stării reale a sistemului, reevaluarea riscului și porțile de însănătoșire"],
        ["Data", "30 august 2026"],
        ["Gazde examinate", "2 din 4 — primară și secundară, cu drept administrativ direct"],
        ["Metodă", "Interogare directă a bazelor, citire de cod, sondare din gazdă în gazdă"],
        ["Volum măsurat", "16 tabele, 36.560 documente, 81.428 intrări de audit, 40.437 linii de cod"],
    ...
    o.append(Paragraph(
        "Toate valorile din acest raport au fost măsurate direct, prin interogarea bazelor de date "
        "de producție, citirea codului care rulează și sondarea rețelei între gazde. "
...
def deco(cv, doc):
    ...
    if doc.page > 1:
        ...
        cv.drawString(LM, PH - TM + 7.5 * mm,
                      "RONOR \u2014 Raport de m\u0103surare \u0219i \u00eens\u0103n\u0103to\u0219ire \u00b7 30 august 2026")
...
def main(src, out):
    ...
    doc = BaseDocTemplate(out, pagesize=A4,
                          ...
                          title="RONOR \u2014 Raport de m\u0103surare \u0219i \u00eens\u0103n\u0103to\u0219ire, 30 august 2026",
                          author="NrgPaths Advisory Ltd",
                          subject="M\u0103surare \u0219i \u00eens\u0103n\u0103to\u0219ire RONOR",
