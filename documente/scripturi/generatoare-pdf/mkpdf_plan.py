...
def cover():
    o = [Spacer(1, 28 * mm)]
    o.append(Paragraph("PLAN DE REPARA\u021aII", S["cover_t"]))
    o.append(Spacer(1, 5))
    ...
    o.append(Spacer(1, 3))
    o.append(Paragraph("Registrul de lucr\u0103ri, ordonat pe por\u021bi de dependen\u021b\u0103", S["cover_s2"]))
...
def deco(cv, doc):
    ...
    if doc.page > 1:
        ...
        cv.drawString(LM, PH - TM + 7.5 * mm,
                      "RONOR \u2014 Plan de repara\u021bii \u00b7 25 august 2026")
...
def main(src, out):
    ...
    doc = BaseDocTemplate(out, pagesize=A4,
                          ...
                          title="RONOR \u2014 Plan de repara\u021bii, 25 august 2026",
                          author="NrgPaths Advisory Ltd",
                          subject="Plan de repara\u021bii RONOR",
